# expenseToExcel
some banks do not convert expense reports to csv for you because they are stuck in the mid 2000s. So I wrote this python thing.

So this is a generic test document. You might be thinking "Most banks will let you download records directly to your computer as a csv. Why do you need this???" Well some banks have not heard of csv files and just give you a webpage and say "good luck". So, I wrote a parser in python. Copy the content of the page to "Generic.txt" and my parser will give you a csv you can put in excel.
